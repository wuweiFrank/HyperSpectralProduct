...
/*---------------------------------影像进行采样--------------------------------*/
long CSampleFunc::nearest_sample(const char* pathIn,int xsamplesize,int ysamplesize,const char* pathOut)
{
...
long CSampleFunc::biliner_sample(const char* pathIn,int xsamplesize,int ysamplesize,const char* pathOut)
{
	if(pathIn==NULL||pathOut==NULL)
		return -1;
...
long CSampleFunc::cubic_sample(const char* pathIn,int xsamplesize,int ysamplesize,const char* pathOut)
{
	if(pathIn==NULL||pathOut==NULL)
		return -1;
...
long CSampleFunc::gauss_down_sample(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut)
{
	GDALAllRegister();
...
/*------------------------------多线程影像重采样-------------------------------*/
long CSampleFunc::nearest_sample_thread(const char* pathIn,int xsamplesize,int ysamplesize,const char* pathOut)
{
	if(pathIn==NULL||pathOut==NULL)
		return -1;
...
long CSampleFunc::biliner_sample_thread(const char* pathIn,int xsamplesize,int ysamplesize,const char* pathOut)
{
	if(pathIn==NULL||pathOut==NULL)
		return -1;
...
long CSampleFunc::cubic_sample_thread(const char* pathIn,int xsamplesize,int ysamplesize,const char* pathOut)
{
	if(pathIn==NULL||pathOut==NULL)
		return -1;
