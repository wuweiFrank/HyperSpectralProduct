...
public:
	...
	*/
	long nearest_sample_thread(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut);
	long biliner_sample_thread(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut);
	long cubic_sample_thread(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut);
	...
	/*
		参数：char* pathIn		：输入影像路径
			  ...
			  char* pathOut		：输出结果影像路径
	*/
	long nearest_sample(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut);
	long biliner_sample(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut);
	long cubic_sample(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut);
	long gauss_down_sample(const char* pathIn,int xsampleszie,int ysamplesize,const char* pathOut);
