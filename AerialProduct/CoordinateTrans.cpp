...
//经纬度转地心直角坐标系坐标
long CoordinateTransBasic::BLHToXYZ(double dB, double dL, double dH, THREEDPOINT &XYZPnt)//经纬度->WGS84
{
...
//地心直角坐标系转经纬度
long CoordinateTransBasic::XYZToBLHS(double dB, double dL, double dH, THREEDPOINT *pGoundPnt, int PxelNum)
{
	THREEDPOINT Pnt;
...
//地形直角坐标系转经纬度
long CoordinateTransBasic::XYZToBLH(THREEDPOINT XYZPnt, double &dB, double &dL, double &dH)//WGS84->经纬度
{
	double dB0 = 0;
	double dB1 = 0;
	double dThreshold = 0;
